...
var LOOKUP_SOURCES = [
  ...
  { value: 'job_departments', label: 'Employees by Department' },
          ...
          {form.type === 'lookup' && form.source === 'job_departments' && (
            <div>
              <div className="flex items-center justify-between mb-1">
                <label className="block text-xs font-medium text-gray-600">Filter employees by department</label>
                <span className="text-[11px] text-gray-500">{(form.allowed_dept_ids || []).length} of {departments.length}</span>
              </div>
              <p className="text-[11px] text-gray-400 mb-2">Leave empty to show all employees. Otherwise only employees in ticked departments appear.</p>
