...
var PATHS = {
  ...
  // Two arrows facing opposite ways — a sort control, not a funnel. The
  // dropdown that picks newest-first or highest-first was wearing the filter
  // icon, which is the thing beside it that narrows the list.
